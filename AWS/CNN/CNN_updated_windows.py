...
class Neural_Network:
    ...
    def CNN(self, Normal, Covid, Vp):
        ...
        print("Finished Concatenating....Handling Data Now")
        X_train, X_test, Y_train, Y_test = self.handle_data(X_train, X_test, Y_train, Y_test)
        print("Finished Handling Data....Inputting in CNN")
...
def main():
    ...
    home = "C:/Users/user/Desktop/NN_pictures"

    os.chdir(home)

    print("Currently at Home")
    model = Neural_Network()
    print("Secured NN Model")

    Normal = model.get_all_images(home + '/pics1' )
    print("Got All pictures of Normal")
    Covid = model.get_all_images(home + '/pics2' )
    print("Got All pictures of Second")
    Vp = model.get_all_images(home  + '/pics3')
    print("Got All pictures from third")
